...
module.exports = {
    ...
    entry: {
            index:['babel-polyfill','./src/index.js'], // bundle for index page;
            edit:['babel-polyfill','./src/edit.js'],  //bundle for edit page
            },
    output: {
        path: path.resolve(__dirname, 'public/scripts'),
        filename: '[name]-bundle.js'  //[name] is taken from entry:{} object;
    },
    module:{
    	rules:[{
    		test:/\.js$/,
