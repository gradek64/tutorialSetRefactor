...
(dv_GetParam(b,"isdvvid")||"")+"&uid="+a.uid+"&tagtype="+(dv_GetParam(b,"tagtype")||"")+"&adID="+(dv_GetParam(b,"adID")||"")+"&app="+(dv_GetParam(b,"app")||"")+"&sup="+(dv_GetParam(b,"sup")||"")+"&isovv="+m+"&gmnpo="+(dv_GetParam(b,"gmnpo")||"");(c=dv_GetParam(b,"xff"))&&(m+="&xff="+c);(c=dv_GetParam(b,"useragent"))&&(m+="&useragent="+c);m+="&dup="+dv_GetParam(b,"dup");if(void 0!=window._dv_win.$dvbs.CommonData.BrowserId&&void 0!=window._dv_win.$dvbs.CommonData.BrowserVersion&&void 0!=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent)h=
