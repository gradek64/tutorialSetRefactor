                        ...
                        files.forEach( ( file ) => {
                            ...
                            // only _tuts directories
                                if(stat.isDirectory() && /_tuts$/.test(file)){
                                    let currentPath  = path.join(__dirname, javascirpt_tuts_path, file);
                                        ...
                                        fileContent
                                            ...
                                            .forEach((html)=>{
                                                ...
                                                fs.readFile(htmlPath, 'utf8',  (err,htmlContent) => {
                                                    ...
                                                    //empty file first;
                                                    fs.truncate(destinationListPath+'_all_tuts_lists.html', 0, ()=>{
                                                        //find only list content;
                                                        if(lists){
                                                            lists.forEach((list,i)=>{
                                                                fs.appendFile(destinationListPath+'_all_tuts_lists.html',
