  ...
  create: function create(context) {
    ...
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        var interactiveProps = options[0]
          ? options[0].handlers
          : defaultInteractiveProps;

        var hasInteractiveProps = interactiveProps.some(function(prop) {
          return (
            (0, _jsxAstUtils.hasProp)(attributes, prop) &&
            (0, _jsxAstUtils.getPropValue)(
              (0, _jsxAstUtils.getProp)(attributes, prop)
            ) != null
          );
        });
        ...
        if (!(0, _arrayIncludes2.default)(domElements, type)) {
          ...
          (0, _isAbstractRole2.default)(type, attributes)
        ) {
