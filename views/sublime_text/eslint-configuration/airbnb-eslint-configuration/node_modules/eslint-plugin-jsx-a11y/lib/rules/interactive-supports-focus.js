...
var _isHiddenFromScreenReader2 = _interopRequireDefault(
  _isHiddenFromScreenReader
);
...
var _isNonInteractiveElement2 = _interopRequireDefault(
  _isNonInteractiveElement
);
...
var schema = (0, _schemas.generateObjSchema)({
  tabbable: (0, _schemas.enumArraySchema)(
    []
      .concat(_toConsumableArray(_ariaQuery.roles.keys()))
...
var interactiveProps = [].concat(
  _toConsumableArray(_jsxAstUtils.eventHandlersByType.mouse),
  _toConsumableArray(_jsxAstUtils.eventHandlersByType.keyboard)
);
    ...
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        if (!(0, _arrayIncludes2.default)(domElements, type)) {
          ...
          !hasInteractiveProps ||
          (0, _isHiddenFromScreenReader2.default)(type, attributes) ||
          (0, _isPresentationRole2.default)(type, attributes)
        ) {
        ...
        if (
          hasInteractiveProps &&
          (0, _isInteractiveRole2.default)(type, attributes) &&
          !(0, _isInteractiveElement2.default)(type, attributes) &&
          !(0, _isNonInteractiveElement2.default)(type, attributes) &&
          !(0, _isNonInteractiveRole2.default)(type, attributes) &&
          !hasTabindex
        ) {
