...
var errorMessage = function errorMessage(attr, role, tag, isImplicit) {
  if (isImplicit) {
    return (
      "The attribute " +
      attr +
      " is not supported by the role " +
      role +
      ". This role is implicit on the element " +
      tag +
      "."
    );
  }
    ...
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        var roleValue = role
          ...
          : (0, _getImplicitRole2.default)(type, node.attributes);
        ...
        var invalidAriaPropsForRole = []
          .concat(_toConsumableArray(_ariaQuery.aria.keys()))
