...
var preferButtonErrorMessage =
  "Anchor used as a button. " +
  "Anchors are primarily expected to navigate. " +
  "Use the button element instead.";

var noHrefErrorMessage =
  "The href attribute is required on an anchor. " +
  "Provide a valid, navigable address as the href value.";

var invalidHrefErrorMessage =
  "The href attribute requires a valid address. " +
  "Provide a valid, navigable address as the href value.";
  ...
  create: function create(context) {
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        var hasSpreadOperator =
          attributes.filter(function(prop) {
