...
var ruleByElement = {
  img: function img(context, node) {
    ...
    if (altProp === undefined) {
      ...
      context.report({
        ...
        message:
          nodeType +
          " elements must have an alt prop, either with meaningful text, or an empty string for decorative images."
      });
      return;
    }
    ...
    context.report({
      node: node,
      message:
        "Invalid alt value for " +
        nodeType +
        '. Use alt="" for presentational images.'
    });
  },
  object: function object(context, node) {
    var ariaLabelProp = (0, _jsxAstUtils.getProp)(
      node.attributes,
      "aria-label"
    );
    var arialLabelledByProp = (0, _jsxAstUtils.getProp)(
      node.attributes,
      "aria-labelledby"
    );
    var hasLabel =
      ariaLabelProp !== undefined || arialLabelledByProp !== undefined;
    var titleProp = (0, _jsxAstUtils.getLiteralPropValue)(
      (0, _jsxAstUtils.getProp)(node.attributes, "title")
    );
    ...
    if (
      hasLabel ||
      hasTitleAttr ||
      (0, _hasAccessibleChild2.default)(node.parent)
    ) {
      return;
    }
  ...
  area: function area(context, node) {
    var ariaLabelPropValue = (0, _jsxAstUtils.getPropValue)(
      (0, _jsxAstUtils.getProp)(node.attributes, "aria-label")
    );
    var arialLabelledByPropValue = (0, _jsxAstUtils.getPropValue)(
      (0, _jsxAstUtils.getProp)(node.attributes, "aria-labelledby")
    );
    var hasLabel =
      ariaLabelPropValue !== undefined ||
      arialLabelledByPropValue !== undefined;
  ...
  'input[type="image"]': function inputImage(context, node) {
    ...
    var nodeType = (0, _jsxAstUtils.elementType)(node);
    if (nodeType === "input") {
      var typePropValue = (0, _jsxAstUtils.getPropValue)(
        (0, _jsxAstUtils.getProp)(node.attributes, "type")
      );
...
module.exports = {
  ...
  create: function create(context) {
    ...
    var customComponents = elementOptions
    ...
    var typesToValidate = new Set(
      (_ref = []).concat
        .apply(
          _ref,
          [customComponents].concat(_toConsumableArray(elementOptions))
        )
        .map(function(type) {
