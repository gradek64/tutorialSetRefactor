    ...
    return {
      JSXElement: function JSXElement(node) {
        ...
        var trackChildren = node.children.filter(function(child) {
          ...
          return isTrackType(
            context,
            (0, _jsxAstUtils.elementType)(child.openingElement)
          );
        });
        ...
        var hasCaption = trackChildren.some(function(track) {
          var kindProp = (0, _jsxAstUtils.getProp)(
            track.openingElement.attributes,
            "kind"
          );
          var kindPropValue =
            (0, _jsxAstUtils.getLiteralPropValue)(kindProp) || "";
