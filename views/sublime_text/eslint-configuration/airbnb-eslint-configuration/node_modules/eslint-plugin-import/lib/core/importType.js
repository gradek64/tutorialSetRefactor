...
function isBuiltIn(name, settings) {
  ...
  return (
    _builtinModules2.default.indexOf(name) !== -1 || extras.indexOf(name) > -1
  );
}
...
function isExternalPath(path, name, settings) {
  ...
  return (
    !path ||
    folders.some(folder => -1 < path.indexOf((0, _path.join)(folder, name)))
  );
}
...
const typeTest = (0, _lodash2.default)([
