...
module.exports = {
  ...
  create: Components.detect((context, components, utils) => {
        ...
        switch (callName) {
          ...
          case "oneOfType":
            ...
            for (let i = 0, j = argument.elements.length; i < j; i++) {
              const type = buildReactDeclarationTypes(
                argument.elements[i],
                parentName
              );
    ...
    function getPropertyName(node) {
      ...
      const isDirectNextProp = DIRECT_NEXT_PROPS_REGEX.test(
        sourceCode.getText(node)
      );
      const isDirectPrevProp = DIRECT_PREV_PROPS_REGEX.test(
        sourceCode.getText(node)
      );
      ...
      if (
        (isDirectProp || isDirectNextProp || isDirectPrevProp) &&
        isInClassComponent &&
        isNotInConstructor &&
        ...
        case "VariableDeclarator":
          for (let i = 0, j = node.id.properties.length; i < j; i++) {
            ...
            const thisDestructuring =
              ...
              ((node.id.properties[i].key.name === "props" ||
                node.id.properties[i].key.value === "props") &&
