...
const DEPRECATED_MESSAGE =
  "{{oldMethod}} is deprecated since React {{version}}{{newMethod}}";
...
module.exports = {
  ...
  create: function(context) {
    ...
    function getDeprecated() {
      ...
      deprecated["this.transferPropsTo"] = [
        "0.12.0",
        "spread operator ({...})"
      ];
      // 0.13.0
    ...
    function checkDeprecation(node, method) {
      ...
      context.report({
        ...
        data: {
          ...
          newMethod: deprecated[method][1]
            ? `, use ${deprecated[method][1]} instead`
            : ""
        }
      });
    }
