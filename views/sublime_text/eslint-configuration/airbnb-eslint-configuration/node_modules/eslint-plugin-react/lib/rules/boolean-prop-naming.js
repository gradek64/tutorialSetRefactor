  ...
  create: Components.detect((context, components, utils) => {
    ...
    function reportInvalidNaming(component) {
      component.invalidProps.forEach(propNode => {
        ...
        context.report({
          node: propNode,
          message: `Prop name (${propName}) doesn't match rule (${
            config.rule
          })`,
          data: {
            component: propName
      ...
      "Program:exit": function() {
        ...
        Object.keys(list).forEach(component => {
          ...
          if (
            ...
            const propType = objectTypeAnnotations.get(
              typeNode.typeAnnotation.id.name
            );
            if (propType) {
          ...
          if (
            !has(list, component) ||
            (list[component].invalidProps || []).length
          ) {
