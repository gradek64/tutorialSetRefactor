    ...
    if (match) {
      ...
      if (comment.type === "Block") {
        switch (match[1]) {
          case "exported":
            Object.assign(
              commentConfig.exported,
              parseBooleanConfig(value, comment)
            );
            break;
          ...
          case "eslint-disable":
            [].push.apply(
              disableDirectives,
              createDisableDirectives("disable", comment.loc.start, value)
            );
            break;
          ...
          case "eslint-enable":
            [].push.apply(
              disableDirectives,
              createDisableDirectives("enable", comment.loc.start, value)
            );
            break;
            ...
            if (parseResult.success) {
              Object.keys(parseResult.config).forEach(name => {
                ...
                validator.validateRuleOptions(
                  name,
                  ruleValue,
                  `${filename} line ${comment.loc.start.line}`,
                  linterContext.rules
                );
        ...
        if (match[1] === "eslint-disable-line") {
          [].push.apply(
            disableDirectives,
            createDisableDirectives("disable-line", comment.loc.start, value)
          );
...
function prepareConfig(config, envContext) {
  ...
  preparedConfig.parserOptions.ecmaVersion = normalizeEcmaVersion(
    preparedConfig.parserOptions.ecmaVersion,
    isModule
  );
...
module.exports = class Linter {
  ...
  _verifyWithoutProcessors(textOrSourceCode, config, filenameOrOptions) {
    ...
    if (typeof filenameOrOptions === "object") {
      ...
      reportUnusedDisableDirectives =
        filenameOrOptions.reportUnusedDisableDirectives;
    } else {
    ...
    if (allowInlineConfig !== false) {
      const modifyConfigResult = modifyConfigsFromComments(
        filename,
        sourceCode.ast,
        config,
        this
    ...
    const sharedTraversalContext = Object.freeze(
      Object.assign(Object.create(BASE_TRAVERSAL_CONTEXT), {
        ...
        getDeclaredVariables: scopeManager.getDeclaredVariables.bind(
          scopeManager
        ),
        ...
        Object.assign(Object.create(sharedTraversalContext), {
          ...
          report() {
            ...
            sharedTraversalContext._linter.report(
              ...
              {
                loc: {
                  start: { line: problem.line, column: problem.column - 1 }
                }
              },
              problem.message
            );
    ...
    const eventGenerator = new CodePathAnalyzer(
