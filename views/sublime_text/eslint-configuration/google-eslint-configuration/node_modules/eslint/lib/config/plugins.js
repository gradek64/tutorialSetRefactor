...
class Plugins {
  ...
  static removePrefix(pluginName) {
    return pluginName.startsWith(PLUGIN_NAME_PREFIX)
      ? pluginName.slice(PLUGIN_NAME_PREFIX.length)
      : pluginName;
  }
  ...
  static getNamespace(pluginName) {
    return pluginName.match(NAMESPACE_REGEX)
      ? pluginName.match(NAMESPACE_REGEX)[0]
      : "";
  }
  ...
  define(pluginName, plugin) {
    const pluginNamespace = Plugins.getNamespace(pluginName),
      ...
      pluginNameWithoutPrefix = Plugins.removePrefix(
