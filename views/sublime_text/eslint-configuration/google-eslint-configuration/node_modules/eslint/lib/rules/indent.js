    ...
    function addElementListIndent(elements, startToken, endToken, offset) {
      ...
      elements.forEach((element, index) => {
        ...
        if (
          ...
          if (
            previousElement &&
            sourceCode.getLastToken(previousElement).loc.start.line >
    ...
    const baseOffsetListeners = {
      ...
      ArrowFunctionExpression(node) {
        ...
        if (node.params.length) {
          arrowToken = sourceCode.getTokenAfter(
      ...
      "BinaryExpression, LogicalExpression"(node) {
        ...
        offsets.setDesiredOffsets(
          [tokenAfterOperator.range[1], node.range[1]],
          tokenAfterOperator,
          1
        );
      },
      ...
      ConditionalExpression(node) {
        ...
        if (
          ...
          offsets.setDesiredOffsets(
            [questionMarkToken.range[1], colonToken.range[0]],
            firstConsequentToken,
            0
          );
          offsets.setDesiredOffsets(
            [colonToken.range[1], node.range[1]],
            firstAlternateToken,
            0
          );
        }
      ...
      SwitchStatement(node) {
        ...
        const caseKeywords = node.cases.map(switchCase =>
          sourceCode.getFirstToken(switchCase)
        );
