        ...
        function(e, r, t) {
          ...
          r.exports = function u(e, c, h, r) {
            ...
            function w(e, r, t, a) {
              ...
              if (r.schema != c.schema) return u.call(p, e, r, t, a);
              var o,
                i = !0 === e.$async,
                n = I({
                  isTop: !0,
              ...
              try {
                ...
                (o = l(p, E, P, c, d, y, g, C, A, k)), (d[0] = o);
              } catch (e) {
                throw (p.logger.error(
            ...
            function S(e, r, t) {
              ...
              s = b(r);
              var n = R.call(p, w, c, r);
              if (void 0 === n) {
                var l = h && h[r];
                l &&
                  (n = R.inlineRef(l, f.inlineRefs)
                    ? l
                    : u.call(p, l, c, h, e));
              }
            ...
            function $(e, r, t, a) {
              if (!1 !== p._opts.validateSchema) {
                ...
                if (o) {
                  ...
                  if (!i) {
                    var n =
                      "keyword schema is invalid: " + p.errorsText(o.errors);
                    if ("log" != p._opts.validateSchema) throw new Error(n);
                    p.logger.error(n);
                  }
                }
              }
              ...
              if (u) l = u.call(p, r, t, a);
              else if (h)
                (l = h.call(p, r, t, a)),
                  !1 !== f.validateSchema && p.validateSchema(l, !0);
              else if (c) l = c.call(p, a, e.keyword, r, t);
          ...
          r.exports = function(e, r, t) {
            ...
            if (v) {
              ...
              if ((b = "number" == typeof m) && d) {
                ...
                b && void 0 === n
                  ? ((w = !0),
                    (u = e.errSchemaPath + "/" + (P = f)),
                    (a = m),
                    (g += "="))
                  : (b && (a = Math[p ? "min" : "max"](m, n)),
                    m === (!b || a)
                      ? ((w = !0),
                        (u = e.errSchemaPath + "/" + (P = f)),
                        (g += "="))
                ...
                for (var P, E = -1, w = g.length - 1; E < w; )
                  (P = g[(E += 1)]),
                    ...
                    (a +=
                      ...
                      ") { "),
                    (f += "}");
              (r.compositeRule = p.compositeRule = y),
                (a += " " + f + " if (!" + h + ") {   var err =   "),
                !1 !== r.createErrors
                  ? ((a +=
          ...
          r.exports = function(e, r, t) {
            ...
            a = d
              ? ((s +=
                ...
                "schema" + o)
              : n;
            var p = d ? "(new RegExp(" + a + "))" : e.usePattern(n);
            (s += "if ( "),
              d &&
                (s +=
                  " (" +
        ...
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            if ("#" == n || "#/" == n)
              ...
              if (void 0 === d) {
                var p = e.MissingRefError.message(e.baseId, n);
                if ("fail" == e.opts.missingRefs) {
                  ...
                  if ("ignore" != e.opts.missingRefs)
                    throw new e.MissingRefError(e.baseId, n, p);
                  e.logger.warn(p), u && (o += " if (true) { ");
                }
              } else if (d.inline) {
                var m = e.util.copy(e);
                m.level++;
      ...
      35: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            if (d || f.length) {
              var E = e.errorPath,
                w = d || e.opts.loopRequired <= f.length,
          ...
          r.exports = function(e, r, t) {
            ...
            if (
              ...
              if (
                ...
                "object" == f ||
                "array" == f ||
                (m && (0 <= f.indexOf("object") || 0 <= f.indexOf("array")))
              )
                s +=
                ...
                (s +=
                  ...
                  (s +=
                    " if (" +
                    e.util["checkDataType" + (m ? "s" : "")](f, "item", !0) +
                    ") continue; "),
                  m &&
      ...
      37: [
        function(e, r, t) {
          ...
          r.exports = function(a, e, r) {
            ...
            if (a.isTop) {
              var v = a.isTop;
              (n = a.level = 0), (l = a.dataLevel = 0), (p = "data");
            ...
            if (
              ...
              if (w || E || !0 === S || (S && !J(S))) {
                ...
                if (
                  ((t +=
                    " if (" +
                    a.util[E ? "checkDataTypes" : "checkDataType"](P, p, !0) +
                    ") { "),
                  w)
                ) {
                  var b = "dataType" + n,
                ...
                for (var I = -1, A = O.length - 1; I < A; )
                  if (J((S = O[(I += 1)]))) {
                    if (
                      (S.type &&
                        (t +=
                          " if (" + a.util.checkDataType(S.type, p) + ") { "),
                      ...
                      if ("object" == S.type && a.schema.properties) {
                        ...
                        if (C)
                          for (var k, L = -1, z = C.length - 1; L < z; ) {
                            if (void 0 !== (q = u[(k = C[(L += 1)])]).default)
                              (t +=
                                "  if (" +
                                (Q = p + a.util.getProperty(k)) +
                                " === undefined "),
                        ...
                        if (T) {
                          R = -1;
                          for (var q, N = T.length - 1; R < N; ) {
                            var Q;
                            if (void 0 !== (q = T[(R += 1)]).default)
                              (t +=
                                "  if (" +
                                (Q = p + "[" + R + "]") +
                                " === undefined "),
        ...
        function(e, r, t) {
          ...
          r.exports = function e(r, t) {
            ...
            if (r && t && "object" == typeof r && "object" == typeof t) {
              ...
              var d = f(r);
              if ((s = d.length) !== f(t).length) return !1;
            ...
            (function(e) {
                    ...
                    for (var c = s, h = 1, d = 36; ; d += 36) {
                      ...
                      var p =
                        (r = e.charCodeAt(u++)) - 48 < 10
                          ? r - 22
                          : r - 65 < 26 ? r - 65 : r - 97 < 26 ? r - 97 : 36;
                      (36 <= p || p > L((A - s) / h)) && T("overflow"),
                        (s += p * h);
                      var f = d <= i ? 1 : i + 26 <= d ? 26 : d - i;
                      if (p < f) break;
                      var m = 36 - f;
                  ...
                  for (d && r.push("-"); p < t; ) {
                    ...
                    try {
                      for (
                        ...
                        var $ = F.value;
                        if (($ < a && ++s > A && T("overflow"), $ == a)) {
                          for (var R = s, D = 36; ; D += 36) {
                            var j = D <= o ? 1 : o + 26 <= D ? 26 : D - o;
                            if (R < j) break;
                            var O = R - j,
                              I = 36 - j;
                            r.push(z(N(j + O % I, 0))), (R = L(O / I));
                          }
                          r.push(z(N(R, 0))),
                            (o = Q(s, w, p == d)),
                            (s = 0),
              ...
              function I(e, r) {
                return (
                  ...
                  e
                    .toString()
                    .replace(r && r.iri ? h.PCT_ENCODED : c.PCT_ENCODED, p)
                );
              }
              var U = {
                  scheme: "http",
