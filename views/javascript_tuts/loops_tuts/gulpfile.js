...
gulp.task('sass-to-css', shell.task([
...
gulp.task('generate_nunjucks_config',()=>{
    ...
    const relativeTutsPath = path.join('./javascript_tuts/tuts_all_scripts_css',currentDir);
...
gulp.task('nunjucks',() =>{
    ...
    return gulp.src(srcPages+'/**/*.+(html|nunjucks)')
        .pipe(data(function(file, cb) {
            fs.readFile(xmlFile, 'utf8', 
                (err,data) => { 
