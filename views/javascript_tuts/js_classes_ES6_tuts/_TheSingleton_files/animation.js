...
/* - - - - - - - - -  - - Page Initiation - - - - - - - -- - - - */
	...
	function init() {
		...
		Enabler.isPageLoaded() ? initScenes() : Enabler.addEventListener(studio.events.StudioEvent.PAGE_LOADED, initScenes);
	}
	...
	function addListeners() {
		document.getElementById("clicktag").addEventListener('click', bgExitHandler, false);
	}
...
/* - - - - - - - - -  Dynamic Studio Functions - - - - - -- - - - */
	...
	function setupDynamic() {
		...
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].REPORTING_LABEL = "default_300x250";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].PUBLISHER = "DV360";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].DCM_PLACEMENT_ID = "";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].LINE_ITEM_ID = "";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].IS_DEFAULT = true;
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].ACTIVE = true;
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].START_DATE = {};
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].START_DATE.RawValue = "1/1/2022";
		...
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].END_DATE.RawValue = "12/31/2022";
		...
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].EXIT_URL.Url = "https://hyperoptic.com/";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].LOGO_IMG = {};
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].LOGO_IMG.Type = "file";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].LOGO_IMG.Url = "https://s0.2mdn.net/ads/richmedia/studio/29136062/29136062_20220120084421582_hyperoptic_logo.png";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_1_BG = {};
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_1_BG.Type = "file";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_1_BG.Url = "https://s0.2mdn.net/ads/richmedia/studio/29136062/29136062_20220120083232936_default_frame_1_300x600.jpg";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_2_BG = {};
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_2_BG.Type = "file";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_2_BG.Url = "https://s0.2mdn.net/ads/richmedia/studio/29136062/29136062_20220120083236185_default_frame_2_300x600.jpg";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_3_BG = {};
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_3_BG.Type = "file";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_3_BG.Url = "https://s0.2mdn.net/ads/richmedia/studio/29136062/29136062_20220120083239182_default_frame_3_300x600.jpg";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_END_BG = {};
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_END_BG.Type = "file";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_END_BG.Url = "https://s0.2mdn.net/ads/richmedia/studio/29136062/29136062_20220120083242260_default_frame_4_300x600.jpg";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].VIDEO_BG = {};
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].VIDEO_BG.Type = "video";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].VIDEO_BG.Progressive_Url = "http://gcdn.2mdn.net/videoplayback/id/c99e237b796fce80/itag/15/source/doubleclick/ratebypass/yes/mime/video%2Fmp4/acao/yes/ip/0.0.0.0/ipbits/0/expire/3787145819/sparams/id,itag,source,ratebypass,mime,acao,ip,ipbits,expire/signature/77C4C67868B954B0E87210D6BA7AC49C1F0B72ED.6E1552FCE6ABFC8F36DBBD39AFE4D995637EF82E/key/ck2/file/file.mp4";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].AWARD_IMG = {};
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].AWARD_IMG.Type = "file";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].AWARD_IMG.Url = "https://s0.2mdn.net/ads/richmedia/studio/29136062/29136062_20220110032824988_trustpilot.png";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_1_COPY = "DON\'T MISS OUR<br> FLASH SALE";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_1_COPY_TCS = "";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_2_COPY = "UNLIMITED FIBRE<br> BROADBAND FROM <br>JUST \u00A315 A MONTH";
		...
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_END_COPY = "HYPEROPTIC.<br> IT\'S HYPEROBVIOUS.";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].FRAME_END_COPY_TCS = "";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].CTA_COPY = "Switch now";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].TERMS_COPY = "";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].AD_BG_COLOUR = "#ffffff";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].CTA_COLOUR = "#ffffff";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].CTA_BG_COLOUR = "#706290";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].CTA_FRAME_IN = "1";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].CURVE_VISIBILITY = "ON";
		...
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].CREATIVE_ROUTE = "default";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].TEXT_TRANSITION = "flipInY";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].TEXT_TRANSITION_STAGGER = "characters";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].IMAGE_TRANSITION = "fade";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].CTA_IN_ANIMATION = "fade";
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].CTA_HIGHLIGHT_ANIMATION = "heartbeat";
		...
		devDynamicContent.HYPEROPTIC_DCO_FEED_2022_MASTER_FEED[0].LOOP_COUNT = 2;
	...
	function bindDynamicData(){
		...
		dynamic.FRAME_1_COPY_TCS ? f1_txt_tcs.innerHTML = dynamic.FRAME_1_COPY_TCS : null;

		dynamic.FRAME_2_COPY ? f2_txt.innerHTML = dynamic.FRAME_2_COPY : null;
		dynamic.FRAME_2_COPY_TCS ? f2_txt_tcs.innerHTML = dynamic.FRAME_2_COPY_TCS : null;

		dynamic.FRAME_3_COPY ? f3_txt.innerHTML = dynamic.FRAME_3_COPY : null;
		dynamic.FRAME_3_COPY_TCS ? f3_txt_tcs.innerHTML = dynamic.FRAME_3_COPY_TCS : null;

		dynamic.FRAME_END_COPY ? end_txt.innerHTML = dynamic.FRAME_END_COPY : null;
		dynamic.FRAME_END_COPY_TCS ? end_txt_tcs.innerHTML = dynamic.FRAME_END_COPY_TCS : null;
		
		dynamic.TERMS_COPY ? tcs.innerHTML = dynamic.TERMS_COPY : null;

		dynamic.CTA_COPY ? cta_txt.innerHTML = dynamic.CTA_COPY : null;
		dynamic.CTA_BG_COLOUR ? cta.style.backgroundColor = dynamic.CTA_BG_COLOUR : null;
		...
		cta_highlight_anim = dynamic.CTA_HIGHLIGHT_ANIMATION ? dynamic.CTA_HIGHLIGHT_ANIMATION : 'heartbeat';
		...
		txt_anim_stagger = dynamic.TEXT_TRANSITION_STAGGER ? dynamic.TEXT_TRANSITION_STAGGER : 'none';

		// Curve
		curveVis = dynamic.CURVE_VISIBILITY == "ON" ? true : false;
		dynamic.CURVE_VISIBILITY != "ON" ? addClass(e('curve'), 'hide') : false;
		dynamic.CURVE_OFFSET_X ? curve.style.marginLeft = dynamic.CURVE_OFFSET_X+'px' : null;
		dynamic.CURVE_OFFSET_Y ? curve.style.marginTop = dynamic.CURVE_OFFSET_Y+'px' : null;
		...
		// Frames
		(dynamic.FRAMES && !isNaN(dynamic.FRAMES) && (Number(dynamic.FRAMES) > 1 && Number(dynamic.FRAMES) < 5)) ? fr_length = dynamic.FRAMES : 3;

		// Frame Durations
		frameDur[0] = (dynamic.FRAME_1_DUR && !isNaN(dynamic.FRAME_1_DUR) && Number(dynamic.FRAME_1_DUR) > 0) ? dynamic.FRAME_1_DUR : frameDur[0];
		frameDur[1] = (dynamic.FRAME_2_DUR && !isNaN(dynamic.FRAME_2_DUR) && Number(dynamic.FRAME_2_DUR) > 0) ? dynamic.FRAME_2_DUR : frameDur[1];
		frameDur[2] = (dynamic.FRAME_3_DUR && !isNaN(dynamic.FRAME_3_DUR) && Number(dynamic.FRAME_3_DUR) > 0) ? dynamic.FRAME_3_DUR : frameDur[2];
		frameDur[3] = (dynamic.FRAME_4_DUR && !isNaN(dynamic.FRAME_4_DUR) && Number(dynamic.FRAME_4_DUR) > 0) ? dynamic.FRAME_4_DUR : frameDur[3];
		...
		dynamic.FRAME_END_BG.Url ? srcPaths.push([bg_end, dynamic.FRAME_END_BG.Url]) : null;
...
/* - - - - - - - - - - - - - Animation - - - - - - - - - - - - - */
	...
	function startScene() {
		...
		tl.to(loader,{duration:0.4, alpha:0, onComplete:function(){
			Setup();
		}});
	...
	function Frame1() {
		...
		if(curveVis) tl.from(curve, {duration:0.6, y:'-='+ad.height, ease:'power1.out'}, 0)

		txtAnimIn(f1TxtSplit, txt_anim, tl, txt_anim_stagger, 0.4)

		tl.from(logo, {duration:0.6, alpha:0}, 0.4)

		tl.from(award, {duration:0.6, alpha:0}, '-=0.2')

		if(cta_frame_in == '1') ctaAnimIn(cta, cta_txt, cta_anim, tl, '-=0.4', ad.width, ad.height)

		tl.from(f1_txt_tcs, {duration:0.4, alpha:0}, '-=0.3')

		fr_length > 2 ? wait(tl.duration() + frameDur[0], Frame2) : wait(tl.duration() + frameDur[0], Frame4);
	...
	function Frame2() {
		...
		if(cta_frame_in == '2') ctaAnimIn(cta, cta_txt, cta_anim, tl, '-=0', ad.width, ad.height)

		fr_length > 3 ? wait(tl.duration() + frameDur[1], Frame3) : wait(tl.duration() + frameDur[1], Frame4);
	...
	function Frame3() {
		...
		if(cta_frame_in == '3') ctaAnimIn(cta, cta_txt, cta_anim, tl, '-=0', ad.width, ad.height)
	...
	function Frame4() {
		...
		if(cta_frame_in == '4') ctaAnimIn(cta, cta_txt, cta_anim, tl, '+=0.2', ad.width, ad.height)
	...
	function Replay() {
		...
		if (loopCount < loops) {
			...
			tl = new gsap.timeline()
			tl.to(loader, {duration:0.4, alpha:1, onComplete:function(){
				reset();
			}});
...
/* - - - - - - - - - - - Frame Functions - - - - - - - - - - - */
	...
	function showTerms(t1,t2,tl) {
		if(t1.innerText == t2.innerText) {
			...
			tl.to(t1, {duration:0.2, alpha:0}, 0).to(t2, {duration:0.5, alpha:1}, 0.6)
		}
	}
...
/* - - - - - - - - - - - Global Functions - - - - - - - - - - - */
	...
	function e(t){return document.getElementById(String(t))}function ecs(t){return document.getElementsByClassName(String(t))}function resetAll(){var t=ecs("lyr");gsap.killTweensOf(t),gsap.set(t,{x:0,y:0,rotation:rot0(),scale:1,opacity:1}),hide(t)}function wait(t,e,n){n=void 0!==n?n:[],Math.abs(t)<1e-4?e.apply(window,n):gsap.delayedCall(t,e,n,window)}function hasClass(t,e){return t.classList?t.classList.contains(e):!!t.className.match(new RegExp("(\\s|^)"+e+"(\\s|$)"))}function addClass(t,e){t.classList?t.classList.add(e):hasClass(t,e)||(t.className+=" "+e)}function getBounds(t){var e={};return e.width=getProp(t,"width"),e.height=getProp(t,"height"),e.left=getProp(t,"left"),e.top=getProp(t,"top"),e}function getProp(t,e){var n=window.getComputedStyle(t,null);return parseInt(n[e])}function getStrProp(t,e){return window.getComputedStyle(t,null)[e]}function stopWatch(t){wait(t=void 0!==t?t:0,function(){!1===F?F=(F=new Date).getTime():((new Date).getTime(),F=!1)})}function browserSupportsSubpixel(){var t=-1!==navigator.userAgent.toLowerCase().indexOf("firefox"),e=/MSIE|Trident/.test(window.navigator.userAgent);return!t&&!e}function rot0(){return browserSupportsSubpixel()?0:.01}function hide(t){gsap.set(t,{opacity:0})}function show(t){gsap.set(t,{opacity:1})}const pSBC=(t,e,n,r)=>{let s,i,a,o,l,u,g,p=parseInt,c=Math.round,d="string"==typeof n;return"number"!=typeof t||t<-1||t>1||"string"!=typeof e||"r"!=e[0]&&"#"!=e[0]||n&&!d?null:(this.pSBCr||(this.pSBCr=(t=>{let e=t.length,n={};if(e>9){if([s,i,a,d]=t=t.split(","),(e=t.length)<3||e>4)return null;n.r=p("a"==s[3]?s.slice(5):s.slice(4)),n.g=p(i),n.b=p(a),n.a=d?parseFloat(d):-1}else{if(8==e||6==e||e<4)return null;e<6&&(t="#"+t[1]+t[1]+t[2]+t[2]+t[3]+t[3]+(e>4?t[4]+t[4]:"")),t=p(t.slice(1),16),9==e||5==e?(n.r=t>>24&255,n.g=t>>16&255,n.b=t>>8&255,n.a=c((255&t)/.255)/1e3):(n.r=t>>16,n.g=t>>8&255,n.b=255&t,n.a=-1)}return n})),g=e.length>9,g=d?n.length>9||"c"==n&&!g:g,l=this.pSBCr(e),o=t<0,u=n&&"c"!=n?this.pSBCr(n):o?{r:0,g:0,b:0,a:-1}:{r:255,g:255,b:255,a:-1},o=1-(t=o?-1*t:t),l&&u?(r?(s=c(o*l.r+t*u.r),i=c(o*l.g+t*u.g),a=c(o*l.b+t*u.b)):(s=c((o*l.r**2+t*u.r**2)**.5),i=c((o*l.g**2+t*u.g**2)**.5),a=c((o*l.b**2+t*u.b**2)**.5)),d=l.a,u=u.a,d=(l=d>=0||u>=0)?d<0?u:u<0?d:d*o+u*t:0,g?"rgb"+(l?"a(":"(")+s+","+i+","+a+(l?","+c(1e3*d)/1e3:"")+")":"#"+(4294967296+16777216*s+65536*i+256*a+(l?c(255*d):0)).toString(16).slice(1,l?void 0:-2)):null)};
