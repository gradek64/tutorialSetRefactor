...
!(function (window) {
  ...
  amd.require = function (e, t) {
    ...
    for (var n = [], r = 0; r < e.length; r++) {
      var o = e[r];
      if (!Object.prototype.hasOwnProperty.call(definitions, o))
        throw new RequireDependencyError(
          "No module named " + o + " has been defined"
        );
      n[r] = definitions[o];
    }
    return t.apply({}, n);
  ...
  available(array, "reduce") ||
    (array.reduce = function (e, t) {
      var n = 0;
      for (void 0 === t && (t = this[n++]); n < this.length; n++)
        t = e.call(this, t, this[n], n, this);
      return t;
    }),
  ...
  (amd.define = function (e, t, n) {
    Object.prototype.hasOwnProperty.call(definitions, e) ||
      (definitions[e] = amd.require(t, n));
  }),
  amd))
    define("quant/session", [], function () {
      var e = function () {
        ...
        var t = function () {
          ...
          s = function (e, t) {
            "undefined" != typeof console &&
              console.log.apply(
                console,
                [e + " " + n().toString()].concat([].slice.call(t))
              );
          };
        return {
          now: n,
          ...
          reportError: function (n, r, o) {
            ...
            var a = {
              ...
              version: "b2bd41b7-20221118135330",
              time: t(),
              browser: navigator.userAgent,
              sessionId: e,
            };
            r && "string" == typeof r && (a.label = r),
              n &&
                (n.message && "string" == typeof n.message
                  ? (a.msg = n.message)
                  : "string" == typeof n && (a.msg = n),
                n.stack && "string" == typeof n.stack && (a.stack = n.stack)),
              o.pcode && "string" == typeof o.pcode && (a.pcode = o.pcode);
            var i = new XMLHttpRequest();
            i.open("POST", "https://pixel.quantcount.com/tag/error", !0),
        ...
        return function (t) {
          for (
            var n = t.domain || "",
              ...
              o = new Date(e.nowTimestamp() + 864e5).toUTCString(),
              a = n.split("."),
              i = "",
              u = 2;
            u <= a.length;
            ...
            if (((t.cookie = c), /_dlt=1\b/.test(t.cookie)))
              return (
                (t.cookie =
                  "_dlt=" + "; path=/; domain=" + i + "; expires=" + r),
                i
              );
          }
          return (
            (t.cookie = "_dlt=" + "; path=/; domain=" + i + "; expires=" + r), n
          );
        };
      }),
      ...
      define("quant/ready", [], function () {
        function e() {
          var e = !1,
            t = [];
          document.readyState in { complete: !0, interactive: !0 } && (e = !0);
          var n = function () {
          ...
          document.addEventListener
            ...
            : document.attachEvent &&
              (document.attachEvent("onreadystatechange", n, !1),
      ...
      define("quant/promise", [], function () {
        ...
        var t = 0,
          ...
          o = function (e) {
            return (
              "object" == typeof e && "then" in e && "function" == typeof e.then
            );
          },
          a = function (e) {
            return o(e)
          ...
          var u = function (e, t, n) {
            ...
            return (
              ...
              (o.onreadystatechange = function () {
                o.readyState in { loaded: 1, complete: 1 } && a();
              }),
              (o.onerror = n),
              o
            );
      ...
      define(
        ...
        ["quant/promise", "quant/event", "quant/utils"],
        function (e, t, n) {
          return function (r, o, a, i, u, c, s, f) {
            ...
            (l =
              "object" == typeof i && "function" == typeof i.callApi
                ? function (t, n, r, o) {
          ...
          return function (r, o, a) {
            ...
            if ("function" == typeof o.__uspapi)
              i = function (t, r) {
                return new e(function (e, t) {
                  ...
                  return (
                    n.log.error("uspapi: unsuccessful", e),
                    n.reportError(e, "uspapi: unsuccessful"),
                    !0
                  );
                });
              };
              ...
              t.add(o, "message", function (e) {
                ...
                (i = function (t, o) {
                  ...
                  return new e(function (e, n) {
                    (u[c] = [e, n]),
                      i.postMessage({
                        __uspapiCall: { command: t, version: o, callId: c },
                      });
                  });
                });
            }
            this.consent = function (e) {
              return i("getUSPData", 1).then(function (t) {
                return (
                  t &&
                    "string" == typeof t.uspString &&
                    (e.us_privacy = t.uspString),
                  !0
                );
              });
            };
          ...
          function o(o, c, f) {
            ...
            if ("function" == typeof c.__tcfapi)
              ...
              t.add(c, "message", function (e) {
                ...
                if (void 0 === t)
                  return (
                    n.log.error(a + ": Recieved undefined message"),
                    void n.reportError("Recieved undefined message", a)
                  );
                if ("string" == typeof t && "{" == t[0])
                  try {
                    t = JSON.parse(t);
                ...
                (g = function (t, r) {
                  var a = o.locate(f);
                  if (void 0 === a) return e.resolve({ gdprApplies: !1 });
              ...
              return (
                void 0 === l &&
                  (l = g(d)
                    .then(function (t) {
                      return (
                        t.gdprApplies && "false" != t.gdprApplies
                          ? ((e.gdpr = 1), (e.gdpr_consent = t.tcString))
                          : (e.gdpr = e.gdpr || 0),
                        r(s, t)
                      );
                    })
                    .catch(function (t) {
                      return (
                        n.log.error(a + ": unsuccessful", t),
                        n.reportError(t, a + ": unsuccessful"),
                        (e.gdpr = e.gdpr || 0),
                        !0
                      );
                    })),
        ...
        function e() {
          ...
          this.FNV = function (e) {
            ...
            return (
              ...
              (r = c(t, e)),
              (o = c(n, e)),
              Math.round(Math.abs(r * o) / 65536).toString(16)
            );
          };
          var c = function (e, t) {
            var n;
          ...
          this.SHA256 = function (t) {
            ...
            for (
              ...
              for (var h = 0; h < 16; h++)
                p[d][h] =
                  (t.charCodeAt(64 * d + 4 * h + 0) << 24) |
                  (t.charCodeAt(64 * d + 4 * h + 1) << 16) |
                  (t.charCodeAt(64 * d + 4 * h + 2) << 8) |
                  (t.charCodeAt(64 * d + 4 * h + 3) << 0);
            }
            var v = (8 * (t.length - 1)) / Math.pow(2, 32),
              g = (8 * (t.length - 1)) >>> 0;
            for (
              p[l - 1][14] = Math.floor(v), p[l - 1][15] = g, d = 0;
              d < l;
              d++
            ) {
              ...
              for (y = 16; y < 64; y++)
                m[y] =
                  (a(m[y - 2]) + m[y - 7] + o(m[y - 15]) + m[y - 16]) >>> 0;
              var q = s[0],
                w = s[1],
                _ = s[2],
                b = s[3],
            ...
            for (O = 0; O < s.length; O++)
              s[O] = ("00000000" + s[O].toString(16)).slice(-8);
            return s.join("");
          };
        }
        return new e();
      ...
      define("quant/normalize", ["quant/hashing"], function (e) {
        var t = function (e) {
          var t = typeof e;
          return (
            ("string" == t && e.length > 0) || "number" == t || "boolean" == t
          );
        };
        return function (n, r, o, a, i) {
          ...
          for (u in r)
            Object.prototype.hasOwnProperty.call(r, u) &&
              t(r[u]) &&
              ("uid" !== u && "uh" !== u
                ? "qacct" !== u && (c[u + n] = encodeURIComponent(r[u]))
                : (r[u].match(l)
                    ? ((p = 1), (s = r[u].toLowerCase()))
                    : (r[u].match(f) && ((p = 0), (r[u] = r[u].toLowerCase())),
                      "" !== r[u] && (s = e.SHA256(r[u]))),
                  delete r[u]));
          for (u in o)
            Object.prototype.hasOwnProperty.call(o, u) &&
              t(o[u]) &&
              !c[u + n] &&
              (c[u + n] = encodeURIComponent(o[u]));
          return (
            (c["rf" + n] = "" + i),
            "string" == typeof s &&
              ((r.uh = s), (c["uh" + n] = encodeURIComponent(s))),
            (c["uht" + n] = "" + p),
            (c["a" + n] = a),
            c
          );
      ...
      define("quant/storage-experiment", [], function () {
        ...
        var t = "qcSxl",
          n = "qcSxc";
        return { cleanExperiment: e };
      }),
      define(
        "quant/identity-store",
        ["quant/utils", "quant/hashing"],
        function (e, t) {
          var n = [
              "4dcfa7079941",
              "127fdf7967f31",
            ...
            i = function (t, n, r, o) {
              var a = { value: r, expiry: e.now().getTime() + o };
          ...
          return function (t, c, s) {
            ...
            l || ((f = 1), (l = o())),
              (this.SD = n),
              (this.persistIdentifier = function () {
                1 !== f ||
                  p ||
                  ((c.cookie = [
                    "__qca",
                    ...
                    l,
                    "; expires=",
                    new Date(e.now().getTime() + 338688e5).toGMTString(),
                    "; path=/; domain=",
                    s,
                  ].join("")),
              ...
              (this.removeIdentifier = function () {
                (c.cookie =
                  ...
                  t.localStorage.removeItem("__qca");
              }),
              ...
              (this.getExternalIDString = function (e) {
                ...
                return !r(c.cookie, "_pbjs_id_optout") && "1" !== n && t
                  ? ";pbc=" + t
                  : ";pbc=";
              });
          };
      ...
      define(
        ...
        [
          ...
          "quant/normalize",
          "quant/hashing",
          "quant/storage-experiment",
          "quant/session",
          "quant/utils",
          "quant/identity-store",
        ],
        function (e, t, n, r, o, a, i, u, c, s, f, l, p) {
          function d(d, h, v) {
            var g,
              m,
              y,
              ...
              oe = new a([
                ...
                new o(ne, d, "__uspapiLocator"),
                new i(ne, d, "__tcfapiLocator"),
              ]),
              ae = new p(d, h, te),
              ie = [
                "a",
            ...
            !(function () {
              ...
              (e = h.createElement("script")),
                (g = "async" in e ? 1 : e.readyState ? 2 : 3),
                (e = null);
            })();
            var we = function (e) {
              try {
                ...
                return (
                  l.log.error(e), l.reportError(e, "api", { pcode: de[0] }), !1
                );
              }
            };
            (we.evts = 0),
              ...
              (P = function (e, t) {
                var n,
                  r = e.length;
                for (n = 0; n < r; n++) if (e[n] === t) return !0;
                return !1;
              }),
              (T = function (e) {
                return {}.toString
              ...
              (C = function (e, t) {
                var n = {};
                return (
                  (n.qacct = e.qacct || t.qacct),
                  "load" === e.event || "load" === t.event
                    ? (n.event = "load")
                    : e.event && t.event
                    ? (n.event = e.event || t.event)
                    : (n.event = null),
                  (n.media = null),
                  "webpage" === e.media || "webpage" === t.media
                    ? (n.media = "webpage")
                    : "ad" === e.media || "ad" === t.media
                    ? (n.media = "ad")
                    : (n.media = e.media || t.media),
                  A(n, e, t),
                  A(n, t, e),
                  n.event || delete n.event,
                  n.media || delete n.media,
                  n
                );
              }),
              (A = function (e, t, n) {
              ...
              (H = function () {
                ...
                if (!(ve > 0)) {
                  R();
                  for (e in ye)
                    Object.prototype.hasOwnProperty.call(ye, e) &&
                      ye[e] &&
                      ((t = ye[e]), n.push(t), delete ye[e]);
              ...
              ($ = function () {
                var e,
                  ...
                  n,
                  r = [];
                for (n = de.slice(0), e = 0; e < n.length; e++)
                  (t = n[e]), J(t) || r.push(t);
                if (0 === r.length) H();
                else
              ...
              (j = function (e, t, n, r) {
                var o;
                (e = d.location.protocol + "//" + e),
                  (ge = (h.scripts && h.scripts[0]) || null);
                var a = (ge && ge.parentNode) || h.head || h;
                if (((o = h.createElement("script")), 1 === g))
                  (o.src = e),
                    (o.async = !0),
                    (o.onload = t),
                    n &&
                  ...
                  (o.onload = o.onreadystatechange =
                    function () {
                      i ||
                        ...
                        ((i = !0), (o.onreadystatechange = null), t());
                    }),
                    (o.src = e),
                    a.insertBefore(o, ge);
                } else r && r();
              ...
              (I = function (e) {
                ve++,
                  j(
                    "rules.quantcount.com/rules-" + e + ".js",
                    function () {
                      (he[e] = 2 === g ? 2 : 0), X();
                    },
                    function (t) {
                      (he[e] = 1),
                        l.reportError(t, "ruleFetch", { pcode: e }),
                        X();
                    },
                    function () {
                      (he[e] = 4), X();
              ...
              (L = function (e, t) {
                ...
                if ((r = qe.call(arguments, 2)) && r.length) {
                  for (
                    o = r[0] || N, a = r[1], i = r[2], n = i.length, u = 0;
                    u < n;
                    u++
                  )
                    s.push(!1), f.push(null);
                  (c = { p: e, f: s, r: o, c: i, a: a, v: f }),
                    J(e) || pe.push(e),
                    le.push(c),
                    B(c, l);
                ...
                for (n = 0; n < r; n++)
                  !(function (n) {
                    ...
                    try {
                      (r = e.c[n][0]),
                        (o = e.c[n].slice(1)),
                        o.splice(0, 0, function (r) {
                          (e.f[n] = !0), (e.v[n] = r), Q(e, t);
                        }),
                        r.apply(null, o);
                    } catch (r) {
                      l.reportError(r, "processRule", { pcode: e.p }),
                        (e.f[n] = !0),
                        (e.v[n] = !1),
                        Q(e, t);
                    }
              ...
              (Q = function (e, t) {
                ...
                if (((n = N(f)), n && (n = n && d(p)), n))
                  for (i = 0; i < s.length; i++)
                    try {
                      (r = s[i][0]),
                        (o = s[i].length > 1 ? s[i].slice(1) : []),
                        (o = o.concat(e.v)),
                        (a = r.apply(null, o)),
                        (u = { qacct: e.p, event: "rule" });
                      for (c in a)
                      ...
                      l.reportError(t, "evalRule", { pcode: e.p });
                      continue;
                    }
              }),
              (m = function (e) {
              ...
              (S = function (e, t, n) {
                var r, o, a;
                return (
                  t && "string" == typeof t.qacct
                    ? (r = t.qacct)
                    : "string" == typeof d._qacct && (r = d._qacct),
                  r && 0 !== r.length
                    ? ((t = k(r, t)),
                      delete ye[r],
                      (a = me[r]),
              ...
              (O = function () {
                var e,
                  ...
                  r,
                  o,
                  a = h.getElementsByTagName("meta"),
                  i = "";
                for (e = 0; e < a.length; e++) {
                  if (((o = a[e]), i.length >= 1e3))
                    return encodeURIComponent(i);
                  y(o) &&
                    y(o.attributes) &&
                    y(o.attributes.property) &&
                    y(o.attributes.property.value) &&
                    y(o.content) &&
                    ((t = o.attributes.property.value),
                    (n = o.content),
                    t.length > 3 &&
                      "og:" === t.substring(0, 3) &&
                      (i.length > 0 && (i += ","),
                      (r = n.length > 80 ? 80 : n.length),
                      (i +=
                        m(t.substring(3, t.length)) +
                        "." +
                        m(n.substring(0, r)))));
                }
                return encodeURIComponent(i);
              ...
              (_ = function (e, t) {
                var n,
                  ...
                  A = [];
                if (
                  ((se = 0), y(we.qpixelsent) || (we.qpixelsent = []), y(e))
                ) {
                ...
                if (o) {
                  (n = v.cookieEnabled ? "1" : "0"),
                    y(d._qmeta) &&
                      ((w = ";m=" + encodeURIComponent(d._qmeta)),
                      (d._qmeta = null)),
                    (u = l.now()),
                    (c = l.isDst()),
                    (s = ae.getFirstPartyIDString(se)),
                    (p = ae.getExternalIDString(se)),
                    d.location &&
                      d.location.href &&
                      (_ = encodeURIComponent(d.location.href)),
                    h && h.referrer && (I = encodeURIComponent(h.referrer)),
                    d.self === d.top && (j = "0"),
                    o.url ? (b = _) : (o.url = _),
                    o.ref || (o.ref = I || ""),
                    (r = O()),
                  ...
                  A.push(D + P + "r=" + q + ";" + a[0]),
                    ...
                    A.push(
                      ";ns=" +
                        ...
                        ";ce=" +
                        n +
                        ";qjs=1;qv=b2bd41b7-20221118135330"
                    ),
                    A.push(
                      (o.ref ? "" : ";ref=") +
                        ";d=" +
              ...
              (b = function (e) {
                ...
                oe.consent(function () {
                  ...
                  .then(function (e) {
                    return (
                      e || ae.removeIdentifier(),
                      e ? "quantserve.com" : "quantcount.com"
                    );
                  })
                  .then(function (e) {
                    var n,
                      ...
                      i = [
                        ...
                        r.cm,
                        1 === r.gdpr
                          ? ";gdpr=1;gdpr_consent=" + r.gdpr_consent
                          : ";gdpr=0",
                        r.us_privacy ? ";us_privacy=" + r.us_privacy : "",
                        t[4],
                      ].join("");
                    return (
                      "function" != typeof CustomEvent
                        ? ((n = document.createEvent("CustomEvent")),
                          n.initCustomEvent("q_pixel_fire", !1, !1, { url: i }))
                        : (n = new CustomEvent("q_pixel_fire", {
                            detail: { url: i },
                          })),
                      d.dispatchEvent(n),
                      re.image(i).then(function (t) {
                        t && "number" == typeof t.width && 3 === t.width
                          ? ae.removeIdentifier()
                          : "quantserve.com" === e && ae.persistIdentifier();
                      })
                    );
                  })
                  .catch(function (e) {
              ...
              (Z = function () {
                var e,
                  t,
                  n = arguments;
                for (D([].slice.call(n)), t = 0; t < n.length; t++)
                  (e = n[t]), _(e);
                de.length ? $() : H();
              }),
              (D = function (e) {
                var t,
                  n = T(e);
                if ("array" === n) for (t = 0; t < e.length; t++) D(e[t]);
              ...
              (R = function () {
                ...
                if (
                  (ce ||
                    ...
                    (_({ qacct: d._qacct }), (ce = !0)),
                  !we.evts)
                ) {
                  for (e in d._qevents)
                    d._qevents[e] !== d._qevents.push &&
                      Object.prototype.hasOwnProperty.call(d._qevents, e) &&
                      _(d._qevents[e]);
                  for (e in d.ezt)
                    d.ezt[e] !== d.ezt.push &&
                      Object.prototype.hasOwnProperty.call(d.ezt, e) &&
                      _(d.ezt[e]);
                  (d._qevents = { push: Z }),
                    (d.ezt.push = function () {
                      var e,
              ...
              (q = function () {
                try {
                  y(d._qevents) || (d._qevents = []),
                    y(d.ezt) || (d.ezt = []),
                    W(d._qoptions),
                    W(d.qcdata),
                    W(d.smarttagdata),
                    we.evts || (K(d._qevents), K(d.ezt)),
                    D(d.ezt),
                    D(d._qevents),
                    D({ qacct: d._qacct }),
                    (d._qoptions = null),
      ...
      define("src/main.js", ["quant/quant"], function (e) {
        return (
          void 0 === window.__qc &&
            (window.__qc = new e(window, window.document, window.navigator)),
          window.__qc("init"),
          window.__qc
        );
      });
