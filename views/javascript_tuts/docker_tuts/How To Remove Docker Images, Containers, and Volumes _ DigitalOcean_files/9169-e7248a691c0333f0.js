  ...
  [9169],
  {
    34531: function (e, t, o) {
      ...
      var n = o(59499),
        ...
        r = o(37797),
        a = o(90352),
        l = (0, r.ZP)(a.Z).withConfig({
          displayName: "ButtonLinkStyles__StyledButtonLink",
          componentId: "sc-fgcl9o-0",
        })(
          [
            "align-items:center;background-color:transparent;border:1px solid ",
            ";color:",
            ";cursor:pointer;display:inline-flex;font-size:1em;font-weight:700;padding:16px 32px;text-decoration:none;transition:all 0.3s ease;&:hover{background-color:",
            ";transition:all 0.3s ease;}&.is-squared{border-radius:8px;}&.is-primary{background-color:",
            ";border:1px solid ",
            ";color:",
            ";transition:all 0.3s ease;&:hover{background-color:",
            " !important;border:1px solid ",
            ";color:",
            " !important;transition:all 0.3s ease;}&:disabled{background-color:#c4c9d6 !important;border:1px solid #c4c9d6 !important;color:",
            ";}&.is-outlined{border:1px solid ",
            ";color:",
            ";&:hover{background-color:#f2f8ff !important;border:1px solid ",
            " !important;color:",
            " !important;}&:disabled{background-color:",
            " !important;border:1px solid #8690a9 !important;color:#8690a9 !important;}}}&.is-white{background-color:",
            ";border:1px solid ",
            ";color:",
            ";transition:all 0.3s ease;&:hover{background-color:rgba(225,225,225,0.9);color:",
            ";transition:all 0.3s ease;}&:disabled{border:1px solid #8690a9 !important;color:#8690a9 !important;}&.is-outlined{background-color:transparent;border:1px solid rgba(255,255,255,0.9);color:rgba(255,255,255,0.9);&:hover{background-color:transparent;border:1px solid rgba(255,255,255,1);color:rgba(255,255,255,1);}}}&.is-rounded{border-radius:10px;}&.is-outlined{background-color:transparent;border:1px solid ",
            ";color:",
            ";transition:all 0.3s ease;&:hover{border:1px solid ",
            ";color:",
            ";transition:all 0.3s ease;}}&.is-small{padding:12px 24px;}&.has-center-img{padding:15px 16px;}&.has-left-img{> img{margin-right:8px;}}&.mx-16{margin-right:16px;}&.is-community{border:0;border-radius:8px;cursor:pointer;display:unset;font-size:16px;font-weight:600;height:50px;line-height:50px;margin:5px;padding:0 15px;text-align:center;transition:color 0.2s ease-in-out,background-color 0.2s ease-in-out;&.blue{background-color:",
            ";color:",
            ...
            ";&:hover{background-color:",
            ";color:",
            ";}}&.small{font-weight:500;height:35px;line-height:35px;}&.is-sign-in{border:1px solid ",
            ";display:block;font-weight:400;height:44px;line-height:46px;margin:0;margin-bottom:20px;padding:0 50px;text-decoration:none;&:hover{background-color:",
            ";color:",
            ";}}&.is-community-admin{border-radius:3px;box-sizing:border-box;display:inline-block;height:40px;line-height:34px;margin:0 5px 5px 0;padding:8px;position:relative;transition:opacity 0.2s ease;width:40px;&:last-child{margin-bottom:0;}&:hover{opacity:0.9;}&.is-address{background-color:#fcd042;}&.is-delete{background-color:#e15b5d;}&.is-lock-all-comments{background-color:#fcd042;}&.is-unlock-all-comments{background-color:#fcd042;}&.is-lock-all-answers{background-color:#fcd042;}&.is-unlock-all-answers{background-color:#fcd042;}&.is-lock-new-answers{background-color:#fcd042;}&.is-unlock-new-answers{background-color:#fcd042;}&.is-publish{background-color:",
            ";}&.is-unpublish{background-color:",
            ";}&.is-spam{background-color:#333;}&.is-trash{background-color:#e94849;}&.is-unlist{background-color:#f66106;}&.is-view{background-color:",
            ";}&.is-edit{background-color:#00d7d2;}&.is-deprecate{background-color:",
            ";}&.is-export{background-color:",
            ";}}}",
          ],
          i.ZP.blueDarker,
          i.ZP.blueDarker,
          (0, i.E9)(i.ZP.blueLight, 0.15),
          i.ZP.blue,
          i.ZP.blue,
          i.ZP.white,
          i.ZP.blueLight,
      ...
      var p = function (e) {
          ...
          return (0, s.jsx)(
            l,
            d(d({ className: n, title: i, url: o }, e), {}, { children: t })
          );
        },
        u = p;
      p.defaultProps = { className: "", title: "" };
    },
    19684: function (e, t, o) {
      o.d(t, {
        Z: function () {
          return y;
        },
      ...
      var f = function (e) {
          ...
          var Z = function () {
            return w(
              c ? parseInt(c, 10) : Math.ceil(f.current.offsetWidth / s)
            );
          };
          return (
            (0, a.useEffect)(Z, [s, c]),
            ...
            (0, g.jsx)(
              ...
              x(
                ...
                {},
                {
                  children: (0, i.Z)(Array(b)).map(function (e, t) {
                    return (0,
                    g.jsx)(p, { gap: o, className: "contentStatic", children: P[t] }, (0, l.Z)());
                  }),
                }
              )
            )
          ...
          return (0, v.jsx)(f, {
            ...
            children:
              null === t || void 0 === t
                ...
                : t.map(function (e) {
                    return (0,
                    v.jsx)(a(), { href: (0, i.F7)(u && e.subType ? e.subType || e.tutorial_type : e.type || e.tutorial_type, e.slug), passHref: !0, children: (0, v.jsxs)(y, { image: g, fixedHeight: h, children: [g && (e.header_url ? (0, v.jsx)(P, { src: e.header_url, alt: e.title, title: e.title }) : (0, v.jsx)(P, { src: p.Z.src, alt: e.title, title: e.title })), (0, v.jsxs)(b, { children: [r && (0, v.jsxs)(w, { color: l.j4[e.subType || e.type || e.tutorial_type], upper: d, children: ["// ", (e.relation || e.subType || e.type || e.tutorial_type).replaceAll(/-|_/g, " "), " //"] }), (0, v.jsx)(S, { renderAs: "h3", small: !0, children: e.title }), n && (0, v.jsx)(x, { children: null === e || void 0 === e ? void 0 : e.description }), (0, v.jsxs)(A, { children: ["question" === e.type && (0, v.jsxs)(v.Fragment, { children: [(0, v.jsx)(k, { children: e.answers ? (0, c.M)("answer", e.answers) : "No answers yet" }), (0, v.jsx)(k, { children: " \u2022 " })] }), (0, v.jsx)(k, { children: o && (e.timestamp ? (0, s.Z)(1e3 * e.timestamp) : (0, s.Z)(e.last_validated_at || e.published_at || e.updated_at)) })] })] })] }) }, e.id);
                  }),
          });
        },
        C = _;
    ...
    80298: function (e, t, o) {
      ...
      var n = o(57805),
        ...
        u = s.ZP.div.withConfig({
          displayName: "LearningPathIndexTemplateStyles__StyledDivider",
          componentId: "sc-1jmrbaa-0",
        })(["background-color:", ";height:1px;margin:64px 0;"], a.ZP.gray7),
        g = (0, s.ZP)(c.Z)
          .attrs({ renderAs: "h2" })
          .withConfig({
            displayName: "LearningPathIndexTemplateStyles__StyledHeading",
            componentId: "sc-1jmrbaa-1",
          })(
          [
            "color:",
            ";font-size:24px;font-weight:600;line-height:32px;margin:0 0 40px;",
            "{font-size:32px;font-weight:700;letter-spacing:-0.5px;line-height:40px;}",
          ],
          a.ZP.gray2,
          (0, r.X)(r.A.tablet, "min")
        ),
        m = (0, s.ZP)(p.Z).withConfig({
          displayName: "LearningPathIndexTemplateStyles__StyledTutorialCard",
          componentId: "sc-1jmrbaa-2",
        })(
          [
            "background:",
            ";border-radius:16px;box-shadow:0 6px 20px -6px ",
            ";display:flex;flex-direction:column;height:306px;padding:24px 32px;transition:box-shadow 0.4s ease,transform 0.4s ease;will-change:box-shadow,transform;&:hover{box-shadow:0 10px 20px -2px ",
            ";transform:translateY(-4px);}&:active{transform:scale(0.98);}",
          ],
          a.ZP.white,
          (0, a.E9)(a.ZP.blue1, 0.15),
          (0, a.E9)(a.ZP.blue1, 0.15)
        ),
        h = s.ZP.p.withConfig({
          displayName:
            "LearningPathIndexTemplateStyles__StyledTutorialCardDescription",
          componentId: "sc-1jmrbaa-3",
        })(
          [
            "color:",
            ";display:-webkit-box;font-size:14px;line-height:22px;margin:0;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:4;",
          ],
          a.ZP.gray4
        ),
        x = s.ZP.p.withConfig({
          displayName:
            "LearningPathIndexTemplateStyles__StyledTutorialCardEyebrow",
          componentId: "sc-1jmrbaa-4",
        })(
          [
            "color:",
            ";font-family:",
            ";font-size:14px;font-weight:800;letter-spacing:1px;line-height:24px;margin:0 0 8px;text-transform:capitalize;",
          ],
          function (e) {
            var t = e.subType;
            return a.j4[t];
        ...
        f = s.ZP.p.withConfig({
          displayName:
            "LearningPathIndexTemplateStyles__StyledTutorialCardTitle",
          componentId: "sc-1jmrbaa-5",
        })(
          [
            "color:",
            ";display:-webkit-box;font-family:",
            ";font-size:18px;font-style:normal;font-weight:500;line-height:28px;margin:0 0 8px;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:4;",
          ],
          a.ZP.gray2,
          (0, l.Z)("primary")
        ),
        y = (0, s.ZP)(p.Z).withConfig({
          displayName: "LearningPathIndexTemplateStyles__StyledLanguageCard",
          componentId: "sc-1jmrbaa-6",
        })(
          [
            "background:",
            ";border-radius:16px;box-shadow:0 6px 20px -6px ",
            ";display:grid;gap:4px 32px;grid-template:repeat(2,auto) / auto 1fr;padding:24px 32px;transition:box-shadow 0.4s ease,transform 0.4s ease;will-change:box-shadow,transform;&:hover{box-shadow:0 10px 20px -2px ",
            ";transform:translateY(-4px);}&:active{transform:scale(0.98);}",
          ],
          a.ZP.white,
          (0, a.E9)(a.ZP.blue1, 0.15),
        ...
        b = s.ZP.p.withConfig({
          displayName:
            "LearningPathIndexTemplateStyles__StyledLanguageCardEyebrow",
          componentId: "sc-1jmrbaa-7",
        })(
          [
            "color:",
            ";font-family:",
        ...
        w = (0, s.ZP)(d.Z).withConfig({
          displayName:
            "LearningPathIndexTemplateStyles__StyledLanguageCardImage",
          componentId: "sc-1jmrbaa-8",
        })(["grid-row:1 / -1;"]),
        P = s.ZP.p.withConfig({
          displayName:
            "LearningPathIndexTemplateStyles__StyledLanguageCardLanguage",
          componentId: "sc-1jmrbaa-9",
        })(
          [
            "color:",
            ";font-family:",
        ...
        C = o(4486),
        S = o(94216),
        I = "/_next/static/media/wantToLearnMoreDesktopCTA.5ac38be7.png",
        j = "/_next/static/media/wantToLearnMoreTabletCTA.247b9f29.png",
        T = o(44154),
        L = s.ZP.div.withConfig({
          displayName: "BaseLayoutStyles__StyledWrapper",
          componentId: "sc-1hco4f-0",
        })(["background-color:", ";"], a.ZP.gray10),
        N = (0, s.iv)(["margin:auto;padding-top:72px;"]),
        D = (0, s.ZP)(C.Z).withConfig({
          displayName: "BaseLayoutStyles__StyledTextLink",
          componentId: "sc-1hco4f-1",
        })(
          [
            "color:",
        ...
        z = (0, s.iv)(
          [
            "align-items:center;div:first-of-type{h3{font-size:48px;font-weight:800;letter-spacing:-2px;line-height:49px;}p{color:",
            ";margin:0;}}img{align-self:flex-end;display:block;height:100%;margin:24px 56px 0 0;width:auto;}",
            "{div:first-of-type{text-align:center;}img{display:none;}}",
            "{div:first-of-type{padding:32px 64px;h3{font-size:56px;line-height:96px;margin:0;}p{font-size:18px;line-height:28px;}}}",
            "{margin-bottom:32px;}",
          ],
          a.ZP.white,
          (0, r.X)(r.A.tablet),
          (0, r.X)(r.A.tablet, "min"),
          (0, r.X)(r.A.largeDesktop)
        ),
        E = (0, s.iv)(
          [
            "align-items:center;div:first-of-type{h3{line-height:32px;margin:0;}p{margin:16px 0;}}img{display:block;height:100%;width:auto;}",
            "{img{display:none;}}",
            "{div:first-of-type{padding:32px 64px;h3{font-size:32px;line-height:40px;}}}",
          ],
          (0, r.X)(r.A.tablet),
          (0, r.X)(r.A.tablet, "min")
        ),
                ...
                children: [
                  (0, B.jsx)(_.Z, {
                    ...
                    links: [
                      ...
                      { text: "Browse all topic tags", url: "/community/tags" },
                      {
                        text: "Ask a Question",
                      ...
                      return (0,
                      B.jsx)(D, { url: e.url, dashArrow: !0, children: e.text }, e.text);
                    }),
                  }),
                  (0, B.jsxs)(T.w1, {
                    children: [
        ...
        O = Q;
      Q.defaultProps = { path: { name: "", slug: "" } };
      var X = (0, s.ZP)(k.Z).withConfig({
          displayName: "BaseLayout___StyledContainer",
          componentId: "sc-1hyuy4t-0",
        })(["", ""], N),
        M = (0, s.ZP)(v.Z).withConfig({
          displayName: "BaseLayout___StyledCTA",
          componentId: "sc-1hyuy4t-1",
        })(["", ""], z),
        F = (0, s.ZP)(C.Z).withConfig({
          displayName: "BaseLayout___StyledTextLink",
          componentId: "sc-1hyuy4t-2",
        })(["", ""], T.sr),
        H = (0, s.ZP)(v.Z).withConfig({
          displayName: "BaseLayout___StyledCTA2",
          componentId: "sc-1hyuy4t-3",
        })(["", ""], E),
        W = s.ZP.div.withConfig({
          displayName: "CarouselStyles__StyledCarouselHeader",
          componentId: "sc-16r2urp-0",
        })(["align-items:flex-start;display:flex;"]),
        q = s.ZP.div.withConfig({
          displayName: "CarouselStyles__StyledCarouselControls",
          componentId: "sc-16r2urp-1",
        })(
          [
            ...
            ";margin-left:16px;padding:8px 16px;transition:filter 0.2s ease;&:hover{background-color:",
        ...
        R = s.ZP.div.withConfig({
          ...
          componentId: "sc-16r2urp-2",
        })(
          [
            "--gap-between-items:",
            "px;--items-per-slide:1.1;display:flex;margin:",
            "px;overflow:auto;position:relative;scroll-behavior:smooth;scroll-snap-type:x mandatory;scrollbar-width:none;",
            "{--items-per-slide:2;overflow:hidden;}",
            "{--items-per-slide:",
            ";}&::-webkit-scrollbar{display:none;}",
          ],
          function (e) {
            return e.gapBetweenItems / 2;
          },
          function (e) {
            return -e.gapBetweenItems / 2;
          },
          (0, r.X)(r.A.tablet, "min"),
          (0, r.X)(r.A.desktop, "min"),
          function (e) {
            return e.itemsPerSlide;
          }
        ),
        U = s.ZP.div.withConfig({
          displayName: "CarouselStyles__CarouselItem",
          componentId: "sc-16r2urp-3",
        })([
          "flex-shrink:0;padding:var(--gap-between-items);scroll-snap-align:start;width:calc(100% / var(--items-per-slide));",
        ]),
        G = function (e) {
          var t = e.title,
            o = e.children,
            ...
            m = function (e) {
              l.current.scrollBy({
                top: 0,
                left: l.current.firstElementChild.clientWidth * a * e,
                behavior: "smooth",
              });
            };
          return (
              ...
              children: [
                (0, B.jsxs)(W, {
                  children: [
                    t,
                    n &&
                      (null === o || void 0 === o ? void 0 : o.length) > r &&
                      (0, B.jsxs)(q, {
                        children: [
                          (0, B.jsx)(
                            "button",
      ...
      var Y = "/_next/static/media/cta-ask-questions-left.3c6f7568.svg",
        K = "/_next/static/media/cta-ask-questions-right.6857b04e.svg",
        V = "/_next/static/media/cta-explore-tutorials-bottom.cfa6be4a.svg",
        $ = "/_next/static/media/cta-explore-tutorials-top.f350d99c.svg",
        ee = s.ZP.div.withConfig({
          displayName: "CTABlockStyles__StyledCTABlock",
          componentId: "sc-1f3aslz-0",
        })(
          [
            "background-color:",
            ";border-radius:24px;display:flex;flex-direction:column;gap:32px;margin-bottom:64px;padding:24px;",
            "{margin-bottom:72px;}",
          ],
          a.ZP.experimental.blueLite,
          (0, r.X)(r.A.desktop, "min")
        ),
        te = s.ZP.div.withConfig({
          displayName: "CTABlockStyles__StyledCTAs",
          componentId: "sc-1f3aslz-1",
        })(
          [
        ...
        oe = s.ZP.div.withConfig({
          displayName: "CTABlockStyles__StyledCTA",
          componentId: "sc-1f3aslz-2",
        })(
          [
            "background-color:",
            ";background-image:",
            ";background-position:",
            ";background-repeat:no-repeat;border-radius:16px;color:",
        ...
        ne = s.ZP.p.withConfig({
          displayName: "CTABlockStyles__StyledCTATitle",
          componentId: "sc-1f3aslz-3",
        })(
          [
            "font-family:",
            ";font-size:20px;font-weight:500;line-height:28px;margin:0 0 8px;",
          ],
          (0, l.Z)("primary")
        ),
        ie = s.ZP.p.withConfig({
          displayName: "CTABlockStyles__StyledCTABody",
          componentId: "sc-1f3aslz-4",
        })(["line-height:24px;margin:0 0 24px;"]),
        re = (0, s.ZP)(p.Z).withConfig({
          displayName: "CTABlockStyles__StyledCTALink",
          componentId: "sc-1f3aslz-5",
        })(
          [
            "align-items:center;background-color:",
            ";border-radius:10px;color:",
            ";display:flex;font-weight:600;height:40px;justify-content:center;margin-top:auto;transition:background-color 0.2s ease,color 0.2s ease;will-change:background-color,color;&:hover{background-color:",
            ";color:",
            ";}",
          ],
          a.ZP.white,
        ...
        ae = s.ZP.div.withConfig({
          displayName: "CTABlockStyles__StyledLinks",
          componentId: "sc-1f3aslz-6",
        })(
          [
        ...
        le = (0, s.ZP)(p.Z).withConfig({
          displayName: "CTABlockStyles__StyledLink",
          componentId: "sc-1f3aslz-7",
        })(
          [
            "align-items:center;background-color:",
            ";border-radius:16px;color:",
            ";display:flex;font-size:18px;font-weight:500;height:64px;justify-content:center;line-height:28px;transition:background-color 0.2s ease;will-change:background-color;&:hover{background-color:",
            ";}",
          ],
          a.ZP.blue2,
          a.ZP.white,
            ...
            children: [
              (0, B.jsxs)(te, {
                children: [
                  (0, B.jsxs)(oe, {
                    color: a.ZP.blue2,
                    backgroundImage: "url(".concat($, "), url(").concat(V, ")"),
                    backgroundPosition: "left top, right bottom",
                    children: [
                      (0, B.jsx)(ne, {
                        children: "Explore all of our tutorials",
                      }),
                      (0, B.jsx)(ie, {
                        children:
                      ...
                      (0, B.jsx)(re, {
                        url: "/community/tutorials",
                        color: a.ZP.blue1,
                        children: "Go to Tutorials home",
                      }),
                    ],
                  }),
                  (0, B.jsxs)(oe, {
                    backgroundImage: "url(".concat(Y, "), url(").concat(K, ")"),
                    backgroundPosition: "left bottom, right bottom",
                    color: a.ZP.green2,
                    children: [
                      (0, B.jsx)(ne, { children: "Ask and answer questions" }),
                      (0, B.jsx)(ie, {
                        children:
              ...
              (0, B.jsxs)(ae, {
                children: [
                  (0, B.jsx)(le, {
                    ...
                    children: "Watch our tech talks",
                  }),
                  (0, B.jsx)(le, {
                    url: "/blog",
                    children: "Check out our DO blog",
                  }),
                  (0, B.jsx)(le, {
                    url: "/products",
                    children: "Review DO's product docs",
                  }),
                ],
              }),
            ],
        ...
        ce = function (e) {
          ...
          return (0, B.jsxs)(O, {
            ...
            children: [
              (0, B.jsx)(J, {
                title: (0, B.jsx)(g, { children: "Popular Languages" }),
                children: t.map(function (e, o) {
                  var n = e.url,
                    i = e.image,
                    r = e.language;
                  return (0,
                  B.jsx)(U, { "aria-label": "Slide ".concat(o + 1, " of ").concat(t.length), children: (0, B.jsxs)(y, { url: n, children: [(0, B.jsx)(w, { src: i, alt: r }), (0, B.jsx)(b, { children: "Learn" }), (0, B.jsx)(P, { children: r })] }) }, n);
                }),
              }),
              (0, B.jsx)(u, {}),
              (0, B.jsx)(J, {
                title: (0, B.jsx)(g, { children: "Popular Topics" }),
                children: o.map(function (e, t) {
                  var i = e.slug,
                    ...
                    l = e.description;
                  return (0,
                  B.jsx)(U, { "aria-label": "Slide ".concat(t + 1, " of ").concat(o.length), children: (0, B.jsxs)(m, { url: "/community/".concat((0, n.Z)(r), "/").concat(i), children: [(0, B.jsxs)(x, { subType: r, children: ["// ", r.replaceAll(/-|_/g, " "), " //"] }), (0, B.jsx)(f, { children: a }), (0, B.jsx)(h, { children: l })] }) }, i);
                }),
              }),
              (0, B.jsx)(u, {}),
              (0, B.jsx)(g, { children: "Popular Projects" }),
              (0, B.jsx)(i.Z, {
                records: r,
                showDate: !1,
                showDescription: !0,
        ...
        ue = s.ZP.div.withConfig({
          displayName: "LearningPathTemplateStyles__StyledBody",
          componentId: "sc-16544bq-0",
        })(
          [
            "background:",
            ";border-radius:24px;box-shadow:0 6px 20px -6px ",
            ";padding:32px 40px;details{background:",
            ";padding:16px 0;}p a{border:none;}",
          ],
          a.ZP.white,
        ...
        ge = s.ZP.div.withConfig({
          displayName: "LearningPathTemplateStyles__StyledAnchor",
          componentId: "sc-16544bq-1",
        })(
          [
            "color:",
            ";cursor:pointer;display:block;font-family:",
            ";font-size:16px;font-weight:600;line-height:24px;margin:72px 0;text-align:center;&:hover{color:",
          ...
          return (0, B.jsxs)(O, {
            ...
            children: [
              ...
              (0, B.jsxs)(ge, {
                ...
                children: [(0, B.jsx)(de.Z, {}), "Back to top"],
              }),
            ],
          });
        };
    },
    44154: function (e, t, o) {
      o.d(t, {
        EP: function () {
          return S;
        },
      ...
      var n = o(17534),
        ...
        w = (0, a.iv)(["display:block;margin:72px auto;"]),
        P = a.ZP.div.withConfig({
        ...
        S = a.ZP.div.withConfig({
          ...
          function (e) {
            return e.bg || i.ZP.blueLight;
          },
          function (e) {
            return i.ZP[e.color] || i.ZP.white;
          },
          function (e) {
            return e.margin || "0 0 8px";
          },
          function (e) {
            return e.color && "border: 1px solid ".concat(i.ZP.gray7, ";");
          },
          (0, n.X)(n.A.largeDesktop, "min")
        ),
        I = (0, a.ZP)(s.Z).withConfig({
    ...
    6944: function (e, t, o) {
      ...
      var n = {
        ...
        g = { tutorial: ["beginner", "intermediate", "advanced", "expert"] },
        m = [
          "announcement",
          "blog",
          "blog/author",
        ...
        x = ["tag", "team", "origin", "category", "sub-category"],
        f = {
          defaultPerPage: 100,
          answersPerPage: 3,
          commentsPerPage: 10,
    ...
    94216: function (e, t) {
      t.Z = {
        src: "/_next/static/media/coralWave.2c2197fd.svg",
        height: 183,
        width: 184,
      };
    },
