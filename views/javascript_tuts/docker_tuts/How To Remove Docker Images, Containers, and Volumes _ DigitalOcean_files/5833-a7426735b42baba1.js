                    ...
                    function (e, t, n) {
                      e.exports = {
                        url: function (e, t) {
                          if (
                            e &&
                            [e.link_type, e._linkType, e.linkType].some(
                              function (e) {
                                return (
                                  e &&
                                  [
                ...
                "undefined" != typeof self && self,
                  (e.exports = (function (e) {
                          ...
                          return t.reduce(function (t, n) {
                            ...
                            if (r) {
                              if (
                                ...
                                return (0, a.default)(t).concat([r.concat(n)]);
                              var o = (0, u.default)(r);
                              return o && e(o, n)
                                ? (0, a.default)(t).concat([r.concat(n)])
                                : t.concat([[n]]);
                            }
                            return [[n]];
                          }, []);
                      ...
                      function h(e) {
                        ...
                        var t = y(
                          e.sort(function (e, t) {
                            ...
                            var n = l.PRIORITIES[e.type] - l.PRIORITIES[t.type];
                        ...
                        if (t.length > 0)
                          return (function (e, t, n) {
                            return t.reduce(function (r, o, i) {
                              var a = [],
                                u = 0 === i && o.start > n.lower,
                                c = i === t.length - 1 && n.upper > o.end;
                              if (u) {
                                var s = new f.TextNode(
                                  n.lower,
                                  o.start,
                                ...
                                var l = t[i - 1];
                                if (l && o.start > l.end) {
                                  var d = e.slice(l.end, o.start),
                                    p = new f.TextNode(l.end, o.start, d);
                                  a = a.concat(p);
                                }
                              }
                              if (((a = a.concat(o)), c)) {
                                var y = new f.TextNode(
                                  o.end,
                                  n.upper,
                              ...
                              value: function (e) {
                                return {
                                  ...
                                  children: e.reduce(function (e, t, n) {
                                    if (
                                      s.RichTextBlock.isEmbedBlock(t.type) ||
                                      s.RichTextBlock.isImageBlock(t.type)
                                    )
                                      return e.concat(
                                        new f.BlockNode(t.type, t)
                                      );
                                    var r = (function (e) {
                                      ...
                                      o = e[e.length - 1];
                                    if (
                                      s.RichTextBlock.isListItem(t.type) &&
                                      o &&
                                    ...
                                    if (
                                      s.RichTextBlock.isOrderedListItem(
                                        t.type
                                      ) &&
                                      o &&
                                      o instanceof f.OrderedListBlockNode
                                    ) {
                                      var c = new f.OrderedListItemBlockNode(
                                          t,
                                          r
                                        ),
                                        l = o.addChild(c);
                                      return (0, a.default)(e).concat(l);
                                    }
                                    if (s.RichTextBlock.isListItem(t.type)) {
                                      var d = new f.ListItemBlockNode(t, r),
                                        p = new f.ListBlockNode(
                                          s.RichTextBlock.emptyList(),
                                          [d]
                                        );
                                      return e.concat(p);
                                    }
                                    if (
                                      s.RichTextBlock.isOrderedListItem(t.type)
                                    ) {
                                      var y = new f.OrderedListItemBlockNode(
                                          t,
                                          r
                                        ),
                                        m = new f.OrderedListBlockNode(
                                          s.RichTextBlock.emptyOrderedList(),
                                          [y]
                                        );
                                      return e.concat(m);
                                    }
                    ...
                    function (e, t, n) {
                      ...
                      Object.defineProperty(t, "__esModule", { value: !0 }),
                        (t.ListBlockNode =
                          t.OrderedListBlockNode =
                          t.OrderedListItemBlockNode =
                          t.ListItemBlockNode =
                          t.BlockNode =
                          t.TextNode =
                          t.SpanNode =
                      ...
                      var m = (function (e) {
                        function t(e, n, r, o, i, a) {
                          ...
                          return (
                            p(this, t),
                            ((u = s(this, l(t).call(this, r, a, i))).start = e),
                            (u.end = n),
                            (u.text = o),
                            (u.children = i),
                            u
                      ...
                      var b = (function (e) {
                        function t(e, n, r) {
                          ...
                          return s(
                            this,
                            l(t).call(this, e, n, i.NODE_TYPES.span, r, [], o)
                          );
                        }
                        return f(t, m), t;
                      })();
                        ...
                        function t(e, n) {
                          var r =
                            arguments.length > 2 && void 0 !== arguments[2]
                              ? arguments[2]
                              : [];
                          return p(this, t), s(this, l(t).call(this, e, n, r));
                        }
                        return f(t, y), t;
                      })();
                      t.BlockNode = h;
                      var v = (function (e) {
                        function t(e, n) {
                          return (
                            ...
                            s(
                              this,
                              l(t).call(this, i.NODE_TYPES.listItem, e, n)
                            )
                          );
                        }
                        return f(t, h), t;
                      ...
                      var g = (function (e) {
                        function t(e, n) {
                          return (
                            ...
                            s(
                              this,
                              l(t).call(this, i.NODE_TYPES.oListItem, e, n)
                            )
                          );
                        }
                        return f(t, h), t;
                      })();
                      t.OrderedListItemBlockNode = g;
                      var O = (function (e) {
                        function t(e, n) {
                          return (
                            p(this, t),
                            s(this, l(t).call(this, i.NODE_TYPES.oList, e, n))
                          );
                        }
                        return (
                          f(t, h),
                      ...
                      t.OrderedListBlockNode = O;
                      var x = (function (e) {
                        function t(e, n) {
                          return (
                            p(this, t),
                            s(this, l(t).call(this, i.NODE_TYPES.list, e, n))
                          );
                        }
                        return (
                          f(t, h),
                    ...
                    function (e, t, n) {
                      ...
                      e.exports = function (e) {
                        return function t(n) {
                          for (
                            var o, i, a, u = [], c = 0, s = n.length;
                            c < s;

                          ) {
                            if (r(n[c]))
                              for (
                                a = 0, i = (o = e ? t(n[c]) : n[c]).length;
                                a < i;
                            ...
                            .children.map(function (e, r) {
                              return (function (e, t, n, r) {
                                return (function e(n, o) {
                                  var a =
                                      n instanceof i.SpanNode ? n.text : null,
                                    u = n.children.reduce(function (t, n, r) {
                                      return t.concat([e(n, r)]);
                                    }, []);
                                  return (
                                    (r && r(n.type, n.element, a, u, o)) ||
                                    t(n.type, n.element, a, u, o)
                                  );
                                })(e, n);
                              })(e, t, r, n);
                            });
              ...
              (c = function (e) {
                ...
                (e.exports = function (e, t) {
                  ...
                  return (
                    ...
                    (f.checkPropTypes = a),
                    (f.resetWarningCache = a.resetWarningCache),
                    (f.PropTypes = f),
                    f
                  );
                });
            ...
            "./src/Component.js": function (e, t, n) {
              ...
              var c = function (e) {
                var t = e.Component,
                  ...
                  c = e.linkResolver,
                  s = e.render,
                  l = (e.renderAsText, e.serializeHyperlink),
                  f = a(e, [
                    "Component",
                    "elements",
                    "htmlSerializer",
                      ...
                      (function () {
                        ...
                        return function (t) {
                          for (
                            ...
                            r[o - 1] = arguments[o];
                          return e[t] ? e[t].apply(e, [t].concat(r)) : null;
                        };
                      })({}, [{ type: o.Elements.hyperlink, fn: l }]));
                return s ? Object(i.renderRichText)(s, c, d, t, n, f) : null;
              };
              (c.propTypes = {
            ...
            "./src/richtext.js": function (e, t, n) {
              ...
              function d(e, t, n, i, c, d, m) {
                ...
                switch (n) {
                      ...
                      var o = t.linkTo ? a.Link.url(t.linkTo, e) : null,
                        i =
                          t.linkTo && t.linkTo.target
                            ...
                            : {},
                        u = i.target ? { rel: "noopener" } : {},
                        c = Object(r.createElement)("img", {
                          src: t.url,
                          alt: t.alt || "",
                        });
                      return Object(r.createElement)(
                  ...
                  case o.Elements.embed:
                    return (function (e, t) {
                      u.embeds[e.oembed.provider_name] &&
                        f(u.embeds[e.oembed.provider_name]);
                        ...
                        o = Object.assign(
                          {
                            ...
                            ref: function (t) {
                              u.embeds[e.oembed.provider_name] &&
                                u.embeds[e.oembed.provider_name].load(t);
                            },
                          },
                          e.label
                  ...
                  case o.Elements.hyperlink:
                    return (function (e, t, n, o) {
                      var i = t.data.target ? { target: t.data.target } : {},
                        u = t.data.target ? { rel: "noopener" } : {},
                        c = Object.assign(
                          { href: a.Link.url(t.data, e) },
                          i,
                          u
                        );
                      return Object(r.createElement)("a", p(c, o), n);
                    })(e, i, d, m);
              ...
              var m = function (e) {
                ...
                b = function (e, t, n) {
                  ...
                  var s = i.a.serialize(e, d.bind(null, t, a), n);
                  return Object(r.createElement)(o, u, s);
                };
            },
            0: function (e, t, n) {
