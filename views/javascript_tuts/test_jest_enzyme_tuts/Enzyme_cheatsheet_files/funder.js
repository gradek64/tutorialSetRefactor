(function() {
  function embed () {
    ...
    function trackUplift() {
      try {
        var url = 'https://codefund.io/impressions/767e156b-3cc4-4aa8-aa47-7d063035a8ac/uplift?advertiser_id=185';
    ...
    try {
      ...
      codeFundElement.innerHTML = '<div id="cf"> <div class="cf-wrapper" style="max-width: 330px; display: block; font-size: 14px; line-height: 1.4; font-family: Helvetica, Arial; margin-left: auto; margin-right: auto; padding: 15px;" align="center"> <div class="cf-header" style="font-size: 12px; color: #678; display: block; margin-bottom: 8px;">Proudly sponsored by</div> <a data-href="campaign_url" class="cf-text" target="_blank" rel="nofollow noopener" style="box-shadow: none !important; color: #333; text-decoration: none;"> <strong>CodeFund</strong> <span>has funded over $70,000 to open source projects. Do you qualify? 🤔</span> </a> <a href="https://codefund.app" data-target="powered_by_url" class="cf-powered-by" target="_blank" rel="nofollow noopener" style="box-shadow: none !important; margin-top: 5px; font-size: 11px; display: block; color: #678; text-decoration: none; text-align: center;"> <em>ethical</em> ad by CodeFund <img data-src="impression_url" style="position: fixed; left: -1000px; top: -1000px;"> </a> </div> </div> <style>#cf .cf-header:before { content: " "; margin: 0 0.5em; opacity: 0.5; } #cf .cf-header:after { content: " "; margin: 0 0.5em; opacity: 0.5; } </style>';
      codeFundElement.querySelector('img[data-src="impression_url"]').src = 'https://codefund.io/display/767e156b-3cc4-4aa8-aa47-7d063035a8ac.gif';
      codeFundElement.querySelectorAll('a[data-href="campaign_url"]').forEach(function (a) { a.href = 'https://codefund.io/impressions/767e156b-3cc4-4aa8-aa47-7d063035a8ac/click?campaign_id=144'; });
